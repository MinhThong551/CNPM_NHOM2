...
public class UserDao extends GenericDao<User> implements UserDaoInterface {
    ...
    // Phương thức singleton để trả về một instance của lớp UserDao
    ...
    @Override
    // Phương thức để tìm người dùng theo tên người dùng và mật khẩu
    ...
    @Override
    // Phương thức để tìm danh sách bạn bè của một người dùng
    public List<User> findFriends(String userName) {
        ...
        // Lọc ra danh sách bạn bè và loại bỏ người dùng hiện tại
    ...
    @Override
    // Phương thức để tìm kiếm bạn bè bằng từ khóa
    ...
    @Override
    // Phương thức để tìm người dùng trong cuộc trò chuyện dựa trên ID của cuộc trò chuyện
    ...
    @Override
    // Phương thức để tìm bạn bè không thuộc cuộc trò chuyện dựa trên từ khóa
